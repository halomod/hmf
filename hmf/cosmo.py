from _cache import parameter, Cache, cached_property, simparameter
...
class Cosmology(Cache):
    ...
    __cosmo_params = ["sigma_8", "n", "w", "cs2_lam", "t_cmb", "y_he", "N_nu", "N_nu_massive",
                      "z_reion", "tau", "omegan", "h", "H0", "omegab", "omegac",
                      "omegav", "omegam", "omegab_h2", "omegac_h2"]
    ...
    def cosmo_update(self, **kwargs):
        ...
        for p in easy_params:
            ...
            elif not hasattr(self, "_" + self.__class__.__name__ + "__%s" % p):
...
#                 print "set " + k + "to " + str(val)
        ...
        if len(kwargs) <= 1:
            ...
            if "omegab_h2" in kwargs and "omegac_h2" in kwargs:
                ...
                self.omegac = self.omegam - self.omegac
                self.omegac_h2 = self.omegac * self.h ** 2
