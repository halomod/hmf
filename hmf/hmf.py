...
from transfer import Transfer, _Transfer
from _cache import parameter, cached_property, simproperty
...
#         self._cpdict = {k:v for k, v in transfer_kwargs.iteritems() if k in self._cp}
        ...
        tools.check_kr(self.M[0], self.M[-1], self.mean_dens,
...
class _MassFunction(_Transfer):
    ...
    def __init__(self, Mmin=10, Mmax=15, dlog10m=0.01, mf_fit=Tinker, delta_h=200.0,
        ...
        """
        # # Call super init
        super(_MassFunction, self).__init__(**transfer_kwargs)
    ...
    def update(self, **kwargs):
        ...
        Accepts any argument that the constructor takes.
        """
        super(_MassFunction, self).update(**kwargs)
    ...
    def nu(self):
        """
        The parameter nu, (delta_c/sigma)^2
        """
