...
"""
import numpy as np
from cosmo import Cosmology, _Cosmology
from scipy.interpolate import InterpolatedUnivariateSpline as spline
import cosmolopy as cp
import scipy.integrate as integ
from _cache import cached_property, parameter, simproperty
import copy
import sys
...
class _Transfer(_Cosmology):
    ...
    def __init__(self, z=0.0, lnk_min=np.log(1e-8),
        ...
        '''
        # Call Cosmology init
        super(_Transfer, self).__init__(**kwargs)
    ...
    def update(self, **kwargs):
        ...
        """
        # Cosmology arguments are treated differently
        cosmo_kw = {k:v for k, v in kwargs.iteritems() if hasattr(_Cosmology, k)}
        self.cosmo_update(**cosmo_kw)
        ...
        # Very simply delete all simproperties
